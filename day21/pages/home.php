                        ...
                        <div class="card-body">
                            <form action="action.php" method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="submit" name="btn" class="btn btn-outline-success" value="Check Result">
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label for="" class="col-md-4 col-form-label">Odd/Even</label>
                                    <div class="col-md-8">
                                        <input type="number" class="form-control" name="odd_even">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="" class="col-md-4 col-form-label">Result</label>
                                    <div class="col-md-8">
                                        <input type="text" readonly class="form-control" value="<?php echo isset($resultt) ? $resultt : '' ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="" class="col-md-4 col-form-label"></label>
                                    <div class="col-md-8">
                                        <input type="submit" name="btnn" class="btn btn-outline-success" value="Check Result">
                                    </div>
                                </div>
                            </form>
                        </div>
